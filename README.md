# OAI Provider for Fedora 4 [![Build Status](https://travis-ci.org/ualbertalib/fcrepo4-oaiprovider.svg?branch=dev)](https://travis-ci.org/ualbertalib/fcrepo4-oaiprovider)
